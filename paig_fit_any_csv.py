...
- Optionally fits the initial condition y0 ("estimated") or starts from zeros ("zeros")
- Saves per-program summary and plots if used via the CLI
...
# ------------------------------
# CLI (kept minimal; no ratio/max_nfev options exposed)
# ------------------------------
def main():
    ...
    for inp in args.inputs:
        ...
        print(f"  Global: R2={summary['R2_global']:.3f}, RMSE={summary['RMSE_global']:.3f}, MSE_reduced={summary['MSE_reduced']:.3f}")
